...
void intro()
{
 ...
 settextstyle(7,0,6);
 setcolor(YELLOW);
 outtextxy(2,2,"THE SHUFFLE GAME");
 settextstyle(3,0,4);
 setcolor(RED);
 outtextxy(170,120,"PROJECT MADE BY:");
 setcolor(CYAN);
 settextstyle(2,0,7);
 outtextxy(10,80,"");
 outtextxy(130,200,"MANSI KUMARI");
 setcolor(RED);
 settextstyle(6,0,4);
 outtextxy(125,340,"Computer Science Engineering");
 getch();
}
   ...
   if(win==true)
    {
      cleardevice();
      setbkcolor(BLACK);
      outtextxy(70,200,"You have won the game");
      delay(2000);
      disp();
      delay(2000);
      win=false;
   ...
   if(step==50)
    {
     cleardevice();
     setbkcolor(BLACK);
     outtextxy(70,200,"YOU HAVE SURPASSED MAXIMUM POSSIBLE MOVES");
     delay(1500);
     disp();
     delay(2500);
     exit(1);
...
/* Correct sequence for the above shuffle game is :
   6 3 5 8 2 4 1 2 3 6 4 1 2 3 6 4 1 2 3 6 8 5 4 8 5 7 6 5 8 4 7 8 5 6
*/